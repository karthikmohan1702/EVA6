...
class Net(nn.Module):
    def __init__(self, norm=None, dropout_value = 0.1, num_groups=None):
        ...
        self.convblock1 = self.conv2d(in_channels=1,
                                      out_channels=12,
                                      kernel_size=(3,3),
        ...
        self.convblock2 = self.conv2d(in_channels=12,
                                      out_channels=12,
                                      kernel_size=(3,3),
                                      dropout=dropout_value,
                                      norm=norm,
        ...
        self.convblock3 = self.conv2d(in_channels=12,
                                      out_channels=24,
                                      kernel_size=(3,3),
                                      dropout=dropout_value,
                                      norm=norm,
        ...
        self.convblock4 = self.conv2d(in_channels=24,
                                      out_channels=12,
                                      kernel_size=(1,1),
                                      dropout=dropout_value,
                                      norm=norm,
        ...
        self.convblock5 = self.conv2d(in_channels=12,
                                      out_channels=12,
                                      kernel_size=(3,3),
                                      dropout=dropout_value,
                                      norm=norm,
        ...
        self.convblock6 = self.conv2d(in_channels=12,
                                      out_channels=12,
                                      kernel_size=(3,3),
                                      dropout=dropout_value,
                                      norm=norm,
        ...
        self.convblock7 = self.conv2d(in_channels=12,
                                      out_channels=24,
                                      kernel_size=(3,3),
                                      dropout=dropout_value,
                                      norm=norm,
